    ...
    return(
        <View style={styles.container}>
            ...
            <View style={{flexDirection:"row", justifyContent:"center", alignItems:"center",margin:21}}>
                ...
                <TouchableOpacity onPress={()=>navigation.navigate("Screen1")} style={{width:"57%",height:50, backgroundColor:"#e94141",borderRadius:19, justifyContent:"center",alignItems:"center",marginLeft:39}}><Text style={{fontSize:17,color:"white"}}>Add To Cart</Text></TouchableOpacity> 
            </View>
